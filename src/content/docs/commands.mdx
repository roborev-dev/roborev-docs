...
| `--all-branches` | Discover and refine all branches with failed reviews (implies `--unaddressed`) |
...
| `--all-branches` | Include unaddressed jobs from all branches (implies `--unaddressed`) |
