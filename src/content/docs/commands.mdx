...
```bash
roborev respond <id> "message"   # Add response with message
roborev respond <id>             # Opens editor
...
| Flag | Description |
|------|-------------|
| `--message, -m` | Response message (inline) |
...
roborev prompt --wait "What does main do?"
roborev prompt --agentic "Add tests for main.go"
...
See: [Ad-Hoc Prompts](/guides/ad-hoc-prompts/)
