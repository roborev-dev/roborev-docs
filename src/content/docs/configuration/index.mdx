...
Most global settings are **hot-reloaded** when you edit the file—no daemon restart required. See [Global Configuration](/configuration/global/) for details on which settings hot-reload.
