...
| Agent | Syntax |
|-------|--------|
| Claude Code | `/roborev:review`, `/roborev:review-branch`, `/roborev:design-review`, `/roborev:fix`, `/roborev:address`, `/roborev:respond` |
| Codex | `$roborev:review`, `$roborev:review-branch`, `$roborev:design-review`, `$roborev:fix`, `$roborev:address`, `$roborev:respond` |
...
Skills provide an **interactive** workflow. The review skills (`/roborev:review`, `/roborev:review-branch`, `/roborev:design-review`) let you request reviews from within your agent session and see results inline. The fix skills (`/roborev:fix`, `/roborev:address`) let your agent address findings while you review the changes before committing.
