...
<Screenshot src="/cli-repo-list.svg" alt="roborev repo list output" />
...
When using [PostgreSQL Sync](/guides/postgres-sync/), reviews from teammates are intelligently matched:
