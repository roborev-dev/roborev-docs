...
Press `y` in the TUI to copy the full review content to your clipboard. This makes it easy to:

- Paste into Slack/Discord to discuss with teammates
- Include in GitHub issues or PR descriptions
- Reference in commit messages when addressing findings
