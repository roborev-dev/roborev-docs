...
hero:
  ...
  image:
    html: <img src="/tui-hero.svg" alt="roborev TUI queue view" />
  actions:
    - text: Read Docs
      link: /quickstart/
      icon: right-arrow
...
<div class="agent-matrix">
  ...
  <a href="/agents/"><img src="/agents/pi.svg" alt="Pi" data-agent="pi" width="800" height="800" /></a>
</div>
...
4. **Address findings** by copying reviews into your agent, using [`/roborev-fix`](/guides/agent-skills/), or running `roborev fix`
...
<CardGrid stagger>
  <Card title="Review Ledger" icon="pencil">
  ...
  <Card title="Agent-Ready Feedback" icon="setting">
    Copy findings into your agent session, use `/roborev:fix` skills, or run `roborev fix` to apply fixes automatically.
  </Card>
  ...
  <Card title="Rich Markdown Display" icon="document">
