...
review_types = ["security"]     # "security", "design", or "review" (default)
```
...
| `review_types` | array | `["security"]` | Review types to run for each PR: `security`, `design`, or `review` (e.g., `["security", "review"]`) |
