...
![Copy to clipboard](/tui-copy.gif)

A "Copied to clipboard" message confirms the action. This is useful for:

- Sharing review findings with teammates
- Pasting into issue trackers or documentation
- Including in commit messages or PR descriptions
