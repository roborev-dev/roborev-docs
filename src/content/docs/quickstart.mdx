...
The agent applies changes, commits, and closes the review.
...
You can also browse reviews in the TUI, mark them closed with the `d` key,
...
<Screenshot src="/tui-address.svg" alt="roborev TUI with closed review" />
